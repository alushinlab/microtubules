...
alignparts_lmbfgs=/ru-auth/local/home/sti/johns_progs/alignparts_lmbfgs.exe
#********************************************************************
...
lmbfgsflag=\"\"             # file name modifier for locally aligned particle stacks (use \"\" to not modify root of name)
lmbfgsext=mrcs                 # extension for locally aligned particle stacks
#********************************************************************
# particle and movie information 
boxsize=512                    # boxsize for particles (in pixels)
particleradius=204              # radius for particles within box (in pixels)
pixelsize=1.4375                # pixel size (in Angstroms)
...
framelastali=50                # last frame to be used in alignment
framefirstave=2                # first frame to be used in average of frames
framelastave=50                # last frame to be used in average of frames
#********************************************************************
...
zeroframe=25                   # which frame is considers as unshifted (MUST MATCH THE ZEROFRAME FOR WHOLE FRAME ALIGNMENT)
...
expperframe=1.113                # Exposure per frame in electrons per Angstrom squared
...
factr=1d1                      # Accuracy of minimizer (eg.1.0d7=1.0x10^7 in dble precision, 1d0 extreme)
#=====================================================================
